...
so you have the ability to manipuliate the document
====
...
* JSR [detail]#CDI Specifications, Beans Validation Spec#
...
* We have some time for questions, do you have any questions ?
